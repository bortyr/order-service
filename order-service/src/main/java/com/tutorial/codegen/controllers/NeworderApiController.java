...
@Controller
@RequestMapping("${openapi.orderService.base-path:/v1}")
public class NeworderApiController implements NeworderApi {

    private final NativeWebRequest request;

    @Autowired
    public NeworderApiController(NativeWebRequest request) {
